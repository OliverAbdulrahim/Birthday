...
public class Utilities {
    ...
    /**
     * Computes the difference between the given date and the current one and 
     * returns a formatted {@code String} representing the result.
     * 
     * @param instant The date to calculate the elapsed time from.
     * @return A formatted {@code String} representing the difference between
     *         the given date and the current instant in time.
     */
    public static String diffBetweenNow(LocalDateTime instant) {
        LocalDateTime fromDateTime = instant;
